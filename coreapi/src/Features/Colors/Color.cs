...
public readonly partial record struct Color : IRegexValidation
{
    ...
    public static Color Slate { get; } = From("#62748e");

    public static Color GetRandom(Random? random = null) => (random ?? Random.Shared).GetItems([
        Red, Orange, Amber, Yellow, Lime, Green, Emerald, Teal, Cyan, Sky, Teal, Cyan, Sky, Blue, Indigo, Violet,
